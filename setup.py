...
setup(
    ...
    entry_points={
        'console_scripts': [
            'auto-docker-labels=auto_docker_labels.cli:main',
        ],
    },
    ...
    keywords='auto_docker_labels',
    name='auto_docker_labels',
    packages=find_packages(include=['auto_docker_labels']),
    setup_requires=setup_requirements,
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/khulnasoft/auto_docker_labels',
    version='0.2.3',
    zip_safe=False,
)
